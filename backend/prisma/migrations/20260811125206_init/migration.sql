...
-- AddForeignKey
ALTER TABLE "stock_movements" ADD CONSTRAINT "stock_movements_relatedChallanId_fkey" FOREIGN KEY ("relatedChallanId") REFERENCES "challans"("id") ON DELETE SET NULL ON UPDATE CASCADE;
